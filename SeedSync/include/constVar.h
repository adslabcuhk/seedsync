...
// the type of chunker
enum CHUNKER_TYPE {FIXED_SIZE_CHUNKING = 0, FAST_CDC, LOCALITY_FASTCDC, FSL_TRACE, UBC_TRACE};
...
// for recover/write correctness check
#define RECOVER_CHECK 1

// // for the enclave cache type
// #define NAIVE_CACHE 1
// #define BATCH_CACHE 0
...
enum PROTCOL_CODE_SET {CLIENT_UPLOAD_CHUNK = 0, CLIENT_UPLOAD_SEGMENT_END, 
...
// for sync protocol
enum SYNC_OPT_TYPE {SYNC_OPT = 0, WAIT_OPT};

enum SYNC_PROTOCOL_SET {SYNC_LOGIN = 0, SYNC_LOGIN_RESPONSE, SYNC_FILE_NAME,
    SYNC_FILE_NAME_END_FLAG,
    SYNC_UNI_FILE_NAME, SYNC_UNI_FILE_NAME_END_FLAG,
    SYNC_SEG_FP, SYNC_SEG_FP_END_FLAG, SYNC_SEG_FP_END_FLAG_COND, FILE_END_SEG_FP,
    SYNC_UNI_SEG_FP, SYNC_UNI_SEG_FP_END_FLAG, FILE_END_UNI_SEG_FP,
    SYNC_CHUNK_FP, SYNC_CHUNK_FP_END_FLAG, FILE_END_CHUNK_FP,
    SYNC_UNI_CHUNK_FP, SYNC_UNI_CHUNK_FP_END_FLAG, FILE_END_UNI_CHUNK_FP,
    SYNC_FEATURE, SYNC_FEATURE_END, FILE_END_FEATURE,
    SYNC_LOCAL_DELTA, FILE_END_LOCAL_DELTA,
    SYNC_BASE_HASH, SYNC_BASE_HASH_END_FLAG, FILE_END_BASE_HASH,
    SYNC_DATA, FILE_END_SYNC_DATA, SYNC_DATA_END_FLAG,
    SYNC_FILE_START,
    SYNC_FILE_END};
...
enum HIT_TYPE {NOT_HIT = 0, HIT};

enum MEMORY_POOL_TYPE {META_POOL = 0, DATA_POOL};

enum CLOUD_TYPE {SOURCE_CLOUD = 0, DEST_CLOUD};

enum CACHE_TYPE {FAST12 = 0, BATCH};

// static const uint32_t META_POOL_SIZE = 64; // the number of meta batches in memory pool
static const uint32_t META_POOL_SIZE = 1000; // the number of meta batches in memory pool
...
enum SIM_STATUS {ENCLAVE_SIMILAR_CHUNK = 0, SIMILAR_CHUNK, BATCH_SIMILAR_CHUNK, BASE_CHUNK, ENCLAVE_NON_SIMILAR_CHUNK, NON_SIMILAR_CHUNK, DELTA_COMP_CHUNK, DELTA_ONLY_CHUNK, COMP_ONLY_CHUNK,
LOCAL_DELTA_ONLY_CHUNK, LOCAL_DELTA_COMP_CHUNK};
...
enum IS_SYNC_FILE_END {FILE_END = 0, NOT_FILE_END};
