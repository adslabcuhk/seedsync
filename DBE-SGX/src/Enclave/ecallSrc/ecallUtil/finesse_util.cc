...
#include "../../include/finesse_util.h"
 ...
 */
EcallFinesseUtil::EcallFinesseUtil(uint64_t super_feature_per_chunk, uint64_t feature_per_chunk,
 ...
 * 
 */
EcallFinesseUtil::~EcallFinesseUtil() {
    delete rabin_util_;
}
 ...
 */
void EcallFinesseUtil::ExtractFeature(RabinCtx_t& ctx, uint8_t* data, uint32_t size,
    uint64_t* features) {
