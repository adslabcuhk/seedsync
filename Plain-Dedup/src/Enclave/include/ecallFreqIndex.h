...
#define SEALED_FREQ_INDEX "../../Plain/bin/freq-index"
#define SEALED_SKETCH "../../Plain/bin/cm-sketch"
#define SEALED_HMAC "../../Plain/bin/recipe-hmac"
...
class EcallFreqIndex : public EnclaveBase {
    private:
        ...
        uint8_t hmacKey_[CHUNK_ENCRYPT_KEY_SIZE];
